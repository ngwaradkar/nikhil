...
export default function Contact() {
  ...
  // ROI calculations (85% reduction in manual effort via deterministic Python pipelines)
...
${formData.message}`;
    ...
    const mailtoUrl = `mailto:${siteConfig.personal.email}?subject=${encodeURIComponent(
      formData.subject ? `[Quote Request] ${formData.subject}` : "Automation Feasibility & Quote Inquiry"
  ...
  return (
    <section id="contact" className="section-padding bg-[#0A0E17] relative z-10 border-t border-white/5">
      <div className="container-custom">
        <ScrollReveal>
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            <SectionHeading 
              label="Direct Inquiries & Quote"
              title={siteConfig.contactForm.heading} 
              description="Calculate your potential manual hours and cost savings below, then submit your workflow for a free technical feasibility review."
              align="center"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 max-w-6xl mx-auto">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="panel-elevated p-6 lg:p-7 rounded-2xl border border-[#1F2937] bg-[#131A27] relative overflow-hidden shadow-xl">
                {/* Ambient glow */}
                ...
                <div className="space-y-3 mb-6 relative z-10">
                  <div className="flex items-center justify-between">
                    <label className="text-xs font-mono text-white flex items-center gap-1.5">
                      <Clock size={13} className="text-[#F5A524]" />
                      Hours spent per week on manual Excel / reporting:
                    </label>
                    <span className="text-sm font-mono font-bold text-[#F5A524] bg-[#F5A524]/10 border border-[#F5A524]/20 px-2.5 py-0.5 rounded-lg">
                      {hoursPerWeek} hrs / wk
                    </span>
                  </div>
                  ...
                  <input 
                    ...
                    className="w-full h-2 rounded-lg bg-[#0A0E17] border border-white/10 appearance-none cursor-pointer accent-[#3B82F6]"
                  />
                ...
                <div className="space-y-2.5 mb-6 relative z-10">
                  <div className="flex items-center justify-between">
                    <label className="text-xs font-mono text-white flex items-center gap-1.5">
                      ...
                      Estimated team hourly rate / loaded cost:
                    </label>
                      ...
                      <button
                        ...
                        className={`py-1.5 rounded-xl text-xs font-mono transition-all cursor-pointer border ${
                          hourlyRate === rate && !isCustomRate
                            ...
                            : "bg-[#0A0E17] text-[#8B98AC] border-white/5 hover:border-white/20 hover:text-white"
                        }`}
                      >
                        ${rate}/hr
                      </button>
                    ...
                    {isCustomRate && (
                      <div className="flex items-center gap-1">
                        ...
                        <input
                          ...
                          className="w-16 px-2 py-0.5 rounded bg-[#0A0E17] border border-white/20 text-xs text-white font-mono focus:outline-none focus:border-[#3B82F6]"
                        />
                ...
                <div className="p-4 rounded-xl bg-gradient-to-br from-[#0A0E17] to-[#182234] border border-[#3B82F6]/30 relative z-10 space-y-3 shadow-inner">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {/* Hours Saved */}
                    <div className="p-3 rounded-lg bg-[#131A27]/90 border border-white/5">
                      <div className="text-[10px] font-mono text-[#8B98AC] uppercase">Hours Saved / Year</div>
                      <div className="text-xl font-bold font-mono text-[#22D3EE] mt-0.5">
                        ~{calculation.hoursSavedPerYear.toLocaleString()} <span className="text-xs font-normal text-[#8B98AC]">hrs</span>
                      </div>
                    ...
                    {/* Cost Savings */}
                    <div className="p-3 rounded-lg bg-[#131A27]/90 border border-white/5">
                      <div className="text-[10px] font-mono text-[#8B98AC] uppercase">Estimated Annual Savings</div>
              ...
              {/* Direct Communication Channels Pill */}
              <div className="panel-elevated p-5 rounded-2xl border border-[#1F2937] bg-[#131A27] space-y-3.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs font-mono">
                  <a 
                    ...
                    className="flex items-center gap-2.5 p-2.5 rounded-xl bg-[#0A0E17] border border-white/5 hover:border-[#3B82F6]/40 transition-colors group"
                  >
                    <div className="p-1.5 rounded-lg bg-[#3B82F6]/10 text-[#3B82F6] group-hover:bg-[#3B82F6] group-hover:text-white transition-colors">
                      <Mail size={14} />
                    </div>
                    <span className="truncate text-[#F1F5F9] group-hover:text-[#3B82F6]">{siteConfig.personal.email}</span>
                  </a>

                  <a 
                    href={`tel:${siteConfig.personal.phone}`}
                    className="flex items-center gap-2.5 p-2.5 rounded-xl bg-[#0A0E17] border border-white/5 hover:border-[#A855F7]/40 transition-colors group"
                  >
                    <div className="p-1.5 rounded-lg bg-[#A855F7]/10 text-[#A855F7] group-hover:bg-[#A855F7] group-hover:text-white transition-colors">
                      <Phone size={14} />
                    </div>
                    <span className="truncate text-[#F1F5F9] group-hover:text-[#A855F7]">{siteConfig.personal.phone}</span>
                  </a>
                </div>
            ...
            <div className="lg:col-span-6">
              <div className="panel-elevated p-6 lg:p-8 rounded-2xl border border-[#1F2937] bg-[#131A27] h-full flex flex-col justify-between shadow-xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          ...
                          <input 
                            ...
                            className="w-full px-3.5 py-2.5 rounded-xl bg-[#0A0E17] border border-[#1F2937] text-sm text-white placeholder:text-[#8B98AC]/50 focus:outline-none focus:border-[#3B82F6] transition-colors"
                          />
                        </div>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <textarea 
                          ...
                          className="w-full px-3.5 py-2.5 rounded-xl bg-[#0A0E17] border border-[#1F2937] text-sm text-white placeholder:text-[#8B98AC]/50 focus:outline-none focus:border-[#3B82F6] transition-colors resize-none"
                        />
                      </div>

                      {/* Auto-Attached ROI Payload Notice */}
                      <div className="p-3 rounded-xl bg-[#0A0E17] border border-white/5 flex items-center justify-between text-[11px] font-mono text-[#8B98AC]">
                      ...
                      {/* High-Contrast CTA Submit Button */}
                      <button 
                        type="submit" 
                        className="w-full py-3.5 px-6 rounded-xl font-mono text-sm font-bold text-white tracking-wider flex items-center justify-center gap-2 cursor-pointer transition-all duration-200 border border-white/25 bg-gradient-to-r from-[#3B82F6] via-[#8B5CF6] to-[#A855F7] shadow-[0_4px_22px_rgba(59,130,246,0.4)] hover:shadow-[0_6px_30px_rgba(168,85,247,0.6)] hover:-translate-y-0.5 active:translate-y-0 mt-2"
                      >
